...
//2.Creating Gk and fieldplayer array

const [gk, ...fieldPlayers] = players1;
console.log(gk);
console.log(fieldPlayers);

//3.creating array with all players

const allPlayers = [...players1, ...players2];
console.log(allPlayers);

//4.final team 1 players new array with 3 new player

const players1Final = ["Thiago", "Coutinho", "Perisic", ...players1];
console.log(players1Final);

//5.creating new variable for each odd
...
const printGoals = function (...player) {
  console.log(`${player.length} goal are scored`);
};

printGoals("Davies", "Muller", "Lewandowski", "Kimmich");
printGoals(...game.scored);

//7. Lowest odd more likely to win
